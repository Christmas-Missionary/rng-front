...
// Note: cl.exe doesn't define __SSSE3__
  ...
  // perfectly fine.
  #define SHISHUA_ALIGNR_EPI8(hi, lo, amt) _mm_or_si128(_mm_slli_si128(hi, 16 - (amt)), _mm_srli_si128(lo, amt))
#endif
...
// Don't call these with side effects.
  ...
  #define SHISHUA_SET_EPI64X(b, a)                                                                \
    _mm_set_epi32((int)(((uint64_t)(b)) >> 32), (int)(b), (int)(((uint64_t)(a)) >> 32), (int)(a))
